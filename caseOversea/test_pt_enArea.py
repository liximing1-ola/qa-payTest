...
class TestPayCreate(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        conMysql.updateUserInfoSql('user_bigarea', config.pt_payUid, bigarea_id=1)
        conMysql.updateUserInfoSql('user_bigarea', config.pt_testUid, bigarea_id=1)
    ...
    def test_01_enAreaIMPayGift(self, des='英语区私聊打赏礼物55分成场景'):
        ...
        assert_equal(conMysql.selectUserMoneySql('single_money', config.pt_testUid, money_type='money_cash'), 300)
    ...
    def test_04_enAreaFleetRoomGiveBox(self, des='英语区家族房送箱子55分成场景'):
        ...
        2.giveBox
        3.校验接口状态和返回值数据
        4.检查打赏者账户余额，预期值为：600 - 600 = 0
        5.检查收箱用户账户余额，预期值为：大于150
        """
