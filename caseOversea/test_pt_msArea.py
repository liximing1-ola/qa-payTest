...
class TestPayCreate(unittest.TestCase):
    ...
    def test_01_msAreaFleetRoomPay(self, des='马来区家族房/个人房礼物非主播打赏80%分成'):
        """
        用例描述：
        1.构造打赏者和被打赏者数据
        2.房间内一对一打赏（打赏600分）
        ...
        data = encodePtData(payType='package', rid=conMysql.select_user_chatroom(property='vip', bigarea_id=9))
    ...
    def test_02_msAreaFleetRoomGiveBox(self, des='马来区家族房打赏非主播送箱子80%分成场景'):
        """
        用例描述：
        验证余额足够时，马来区家族房1对1打赏箱子,打赏分成满足非主播上为80%
        脚本步骤：
    ...
    def test_03_msAreaBrokerMemberIMPay(self, des='马来区私聊打赏主播分成50%'):
        """
        用例描述：
        检查马来区私聊一对一打赏礼物，公会成员是一代宗师的用户收到打赏的50%
        脚本步骤：
        1.构造打赏者和被打赏者数据
        2.私聊一对一打赏流程
    ...
    def test_04_msAreaNoBrokerMemberIMPay(self, des='马来区私聊打赏非主播分成50%'):
        """
        用例描述：
        检查马来区私聊一对一打赏礼物，非公会成员是一代宗师的用户收到打赏的50%
        脚本步骤：
        1.构造打赏者和被打赏者数据
        2.私聊一对一打赏流程
