...
class TestPayCreate(unittest.TestCase):
    """
    英语区消费差异化验证：
    1.英语区私聊分成比例主播50%，非主播70%（礼物打赏，箱子打赏）
    ...
    def test_01_enNewAreaChatPay(self, des='英语大区私聊礼物打赏主播55分成场景'):
        """
        用例描述：
        验证余额足够时，英语大区私聊打赏主播普通钻石礼物,打赏分成满足师徒收益(一代宗师)的基础上为5:5
        脚本步骤：
        1.构造打赏者和被打赏者数据
        2.私聊内一对一打赏普通礼物（打赏600分）
        3.校验接口状态和返回值数据，到账money_cash字段
    ...
    def test_02_enNewAreaChatPay(self, des='英语大区私聊礼物打赏非主播73分成场景'):
        """
        用例描述：
        验证余额足够时，英语大区私聊打赏主播普通钻石礼物,打赏分成满足师徒收益(一代宗师)的基础上为7:3
        脚本步骤：
        1.构造打赏者和被打赏者数据
        2.私聊内一对一打赏普通礼物（打赏600分）
    ...
    def test_03_enNewAreaIMPayGiveBox(self, des='英语区私聊打赏非主播箱子73分成场景'):
        """
        用例描述：
        检查账户余额充足时，英语区私聊打赏箱子分成为70%
        脚本步骤：
        1.构造打赏者和被打赏者数据
        2.私聊一对一打赏流程
        3.校验接口和返回值数据,到账money_cash_personal
        4.检查打赏者数据，预期：600 - 600 = 0
        5.检查被打赏者余额,预期为：不小于300*70%=210
        """
    ...
    def test_04_enNewAreaVipRoomGiveBox(self, des='英语大区私聊开箱子打赏主播55分成场景'):
        """
        用例描述：
        验证余额足够时，英语大区商业房1对1打赏箱子,打赏分成满足师徒收益(一代宗师)的基础上为5：5
        脚本步骤：
        1.构造数据（更新xs_user_money，xs_user_commodity，xs_user_box）
        2.giveBox
        3.校验接口状态和返回值数据，到账money_cash
    ...
    def test_05_enNewAreaFleetRoomPay(self, des='英语区家族房礼物打赏主播55分成场景'):
        """
        用例描述：
    ...
    def test_06_enNewAreaFleetRoomGiveBox(self, des='英语区家族房送非主播箱子73分成场景'):
        """
        用例描述：
        验证余额足够时，英语区家族房1对1打赏箱子,打赏分成满足师徒收益(一代宗师)的基础上为70%
        脚本步骤：
        1.构造数据（更新xs_user_money，xs_user_commodity，xs_user_box）
        2.giveBox
        3.校验接口和返回值数据,到账money_cash_personal
