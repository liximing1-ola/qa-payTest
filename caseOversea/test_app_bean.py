...
class TestPayCreate(unittest.TestCase):
    ...
    def test_01_moneyExchangeCoin(self, des: str = '余额兑换金豆场景'):
        ...
        """
        # 1. 构造用户数据
        conMysql.updateMoneySql(config.oversea_payUid, money=300)
        
        # 2. 金豆兑换
        data = encodeOverseaData(payType='exchange_gold')
        ...
        assert_equal(conMysql.selectUserInfoSql('single_money', config.oversea_payUid, money_type='gold_coin'), 600)
