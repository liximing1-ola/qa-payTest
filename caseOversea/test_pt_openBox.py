...
class TestPayCreate(unittest.TestCase):
    ...
    def test_01_openBoxPayChange(self):
        ...
        Assert.assert_equal(Mysql.selectUserCommodity(config.pt_payUid), 2)
    ...
    def test_02_openMoreBoxPayChange(self):
        ...
        Assert.assert_len(Mysql.selectUserCommodity(config.pt_payUid), 12)
        Consts.CASE_LIST[des] = 'pass'
    ...
    def test_03_giveBoxPayChange(self):
        ...
        Assert.assert_body(res['body'], 'success', 1, reason)
        Assert.assert_equal(Mysql.selectAllMoneySql(config.pt_payUid), 100)
        Assert.assert_len(Mysql.selectAllMoneySql(config.pt_payUid), 0)
        Consts.CASE_LIST[des] = 'pass'