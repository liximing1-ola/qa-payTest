...
class TestPayCreate(unittest.TestCase):
    ...
    def test_03_enNewAreaIMPayGiveBox(self, des: str = '英语区私聊打赏非主播箱子 73 分成场景'):
        ...
        conMysql.updateUserextendMoneyClearSql(config.app_testUid)
        ...
        assert_len(conMysql.selectUserInfoSql('money_cash_personal', config.app_testUid, money_type='money_cash_personal'), 210)
