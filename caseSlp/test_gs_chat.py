...
class TestPayCreate(unittest.TestCase):
	...
	def test_01_chatPay(self, des='主播GS-私聊打赏分成60%进mc'):
		"""
		用例描述：
		主播GS-私聊打赏分成60%进mc
		脚本步骤：
		...
		mysql.updateUserMoneyClearSql(gs_A_rid)
		...
		assert_equal(mysql.selectUserInfoSql('single_money', gs_A_rid, 'money_cash'),
