...
## 更新摘要
**变更内容**
- 测试类重构：TestPayCreate重命名为TestPayBean
- 新增setUpClass生命周期管理，用于初始化礼物配置
- 引入setUp/tearDown方法替代之前的直接清理逻辑
- 新增_prepare_test_data和_validate_db_state辅助方法提升代码复用性
- 改进测试结构，增强可维护性和可读性
