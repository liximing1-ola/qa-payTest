...
def ferrisData():
    uid = ('131565025', '131564957', '131542117', '128439987', '105002120', '105002231', '131541046', '131541047',
    ...
    data = encodeData(payType='package-more', uids=uids, rid='200022564', giftId=3, money=52000)
